...
def main():
    ...
    print ("=====================================")
    jenkinsURL = [ "ca1vmlwsqe02", "ca1vmllsqe222"]
    #jenkinsURL = [ "jenkinsserver2:8080" ]
    #jenkinsURL = [ "ca1vmlwsqe02", "ca1vmllsqe222", "jenkinsserver1:8080", "jenkinsserver2:8080", "jenkins-svr3", "ca1vmlwsqe160" ]
    configur = readConfig()
